 ...
 * 
 */
public abstract class STKAbstractItem {
	 ...
	 * @param storageTemp
	 */
	public STKAbstractItem(String name, boolean ageRestricted, int priceInPence, StorageTemp storageTemp) {
		this.setName(name);
	...
	public boolean equals(Object obj) throws IllegalArgumentException {
		...
		if (!(obj instanceof STKAbstractItem)) {
			return false;
		}

		STKAbstractItem paramItem = (STKAbstractItem) obj;
